...
/**
 * Test for the ConstraintCheck-Class {@link LesserThanCheck}.
 * 
 */
public class LesserThanCheckTest {

    /**
     * Comment for <code>MESSAGE_CODE</code>
     */
    private static final String MESSAGE_CODE = "validation.lesser.than";

    /**
     * Comment for <code>ERROR_CODE</code>
     */
    private static final String ERROR_CODE =
            "de.ppi.fuwesta.oval.validation.LesserThan";
    ...
    /** The testee. */
    @InjectMocks
    private LesserThanCheck testee = new LesserThanCheck();

    /** The mock of {@link LesserThan}. */
    @Mock
    private LesserThan mockLesserThanAnnotation;
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(mockLesserThanAnnotation.value()).thenReturn(
                REFERENCE_COLUMN);
        Mockito.when(mockLesserThanAnnotation.message()).thenReturn(MESSAGE);
    }

    /**
     * Test for {@link LesserThanCheck#configure(LesserThan)}.
     */
    @Test
    public void testConfigurationOdCheck() {
        testee.configure(mockLesserThanAnnotation);
